...
public class GameProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, GameContract.PATH, CODE);

        matcher.addURI(authority, GameContract.PATH + "/#", CODE_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, @NonNull ContentValues value) {
        ...
        switch (sUriMatcher.match(uri)) {
            case CODE:
                long id = db.insert(GameContract.Entry.TABLE_NAME, null, value);
                if (id > 0) {
                    returnUri = GameContract.Entry.withId(id);
                } else {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WITH_ID:
                String[] selectionArguments = new String[]{String.valueOf(ContentUris.parseId(uri))};
                numRowsDeleted = db.delete(GameContract.Entry.TABLE_NAME,
                        GameContract.Entry._ID + " = ?",
                        selectionArguments);
                break;
            default:
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case CODE:
                numUpdated = db.update(GameContract.Entry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
